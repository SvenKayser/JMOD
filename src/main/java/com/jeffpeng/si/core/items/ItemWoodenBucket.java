...
public class ItemWoodenBucket extends SICoreItem implements ISIItem {
	...
	public ItemWoodenBucket(String content) {
	...
	public ItemWoodenBucket() {
		...
		emptyBucket = this;
		waterBucket = new ItemWoodenBucket("water");
		milkBucket = new ItemWoodenBucket("milk");
	...
	public void register() {
		GameRegistry.registerItem(emptyBucket, this.internalName);
		GameRegistry.registerItem(waterBucket, this.internalName+"_water");
		GameRegistry.registerItem(milkBucket, this.internalName+"_milk");
